...
![](https://github.com/triple-espress0/sudoku-solver/blob/main/media/demo.gif)
...
1. **Solve the puzzle**:  
- Upon starting a random board is automatically generated. You can choose the solving speed using the slider. Press the "Solve" button to initiate the solving process.

2. **Step-by-Step Visualization:**  
- Observe each step of the backtracking algorithm.

3. **Generate new board:**  
- Once a board is solved, you can generate a new board by pressing the "Generate new" button.  

### Other platforms
Ready packages for various platforms can be downloaded from the following link: [Sudoku solver](https://drive.google.com/drive/folders/1xly12Iwqe6siXbEBl_XwQFZlu7rgi_KK?usp=sharing)
